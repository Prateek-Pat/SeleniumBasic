...
public class Webtable {
	...
	public static void main(String[] args) {
		...
		// Hardcoded row is being used in this script
		...
		// We need to retreive the data from table by column and row wise
		
		// We need to find out the Xpath of the column 1st to retreive the data
